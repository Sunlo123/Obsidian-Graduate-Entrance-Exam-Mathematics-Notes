...
| ![[assets/第2课/ch10-l2-heart-plus-cos.png\|140]]  | 心形线 $r=a(1+\cos\theta)$                                               | 完整图形，$0\le\theta\le2\pi$ | $\frac32\pi a^2$      | $\frac83\pi a^3$（绕极轴）           | $8a$   |
| ![[assets/第2课/ch10-l2-heart-minus-sin.png\|140]] | 心形线 $r=a(1-\sin\theta)$                                               | 完整图形，$0\le\theta\le2\pi$ | $\frac32\pi a^2$      | —                               | $8a$   |
| ![[assets/第2课/ch10-l2-heart-plus-sin.png\|140]]  | 心形线 $r=a(1+\sin\theta)$                                               | 完整图形，$0\le\theta\le2\pi$ | $\frac32\pi a^2$      | —                               | $8a$   |
| ![[assets/第2课/ch10-l2-cycloid.png\|140]]         | 摆线 $x=a(t-\sin t),\ y=a(1-\cos t)$                                    | **一拱**，$0\le t\le2\pi$   | $3\pi a^2$（与 $x$ 轴所围） | $5\pi^2a^3$（绕 $x$ 轴）            | $8a$   |
| ![[assets/第2课/ch10-l2-astroid.png\|140]]         | 星形线 $x=a\cos^3t,\ y=a\sin^3t$，或 $x^{\frac23}+y^{\frac23}=a^{\frac23}$ | 完整图形，$0\le t\le2\pi$     | $\frac38\pi a^2$      | $\frac{32\pi}{105}a^3$（绕 $x$ 轴） | $6a$   |
...
| ------------------------------------ | --------------------------- | ------------------------------------------------- | ---------------- | ----------------------------------- |
| ![[assets/第2课/ch10-l2-lemniscate-cos.png\|140]] | 伯努利双纽线 $r^2=a^2\cos2\theta$ | 两叶沿 $x$ 轴，径向端点为 $(\pm a,0)$                       | $a^2$            | $\frac{\sqrt2}{8}\pi^2a^3$（绕 $y$ 轴） |
| ![[assets/第2课/ch10-l2-lemniscate-sin.png\|140]] | 伯努利双纽线 $r^2=a^2\sin2\theta$ | 两叶沿 $\theta=\frac\pi4$ 与 $\theta=\frac{5\pi}4$ 方向 | $a^2$            | $\frac{\pi^2}{4}a^3$（绕极轴）           |
| ![[assets/第2课/ch10-l2-rose-three-sin.png\|140]] | 三叶玫瑰线 $r=a\sin3\theta$      | 叶片中心方向为 $\frac\pi6,\frac{5\pi}6,\frac{3\pi}2$     | $\frac14\pi a^2$ | —                                   |
| ![[assets/第2课/ch10-l2-rose-three-cos.png\|140]] | 三叶玫瑰线 $r=a\cos3\theta$      | 叶片中心方向为 $0,\frac{2\pi}3,\frac{4\pi}3$             | $\frac14\pi a^2$ | —                                   |
| ![[assets/第2课/ch10-l2-rose-four-sin.png\|140]]  | 四叶玫瑰线 $r=a\sin2\theta$      | 四叶沿两条角平分线方向                                       | $\frac12\pi a^2$ | —                                   |
| ![[assets/第2课/ch10-l2-rose-four-cos.png\|140]]  | 四叶玫瑰线 $r=a\cos2\theta$      | 四叶沿两坐标轴方向                                         | $\frac12\pi a^2$ | —                                   |
...
| --------------------------------------- | ------------------------------- | --------------------------------- | ----------------------------------- | ----------------------------------- |
| ![[assets/第2课/ch10-l2-spiral-archimedes.png\|140]] | 阿基米德螺线 $r=a\theta$，$\theta\ge0$ | $0\le\theta\le2\pi$ 的弧段与极轴所围      | $\frac43a^2\pi^3$                   | —                                   |
| ![[assets/第2课/ch10-l2-spiral-log.png\|140]]        | 对数螺线 $r=e^{a\theta}$            | $0\le\theta\le2\pi$ 的弧段与极轴所围      | $\frac1{4a}(e^{4a\pi}-1)$           | $\frac{\sqrt{1+a^2}}a(e^{2a\pi}-1)$ |
| ![[assets/第2课/ch10-l2-spiral-hyperbolic.png\|140]] | 双曲螺线 $r\theta=a$                | $1\le\theta\le\sqrt3$ 的弧段与两端径向线所围 | $\frac{a^2}{2}(1-\frac{\sqrt3}{3})$ | —                                   |
| ![[assets/第2课/ch10-l2-folium.png\|140]]            | 笛卡儿叶形线 $x^3+y^3-3axy=0$         | 第一象限闭环                            | $\frac32a^2$                        | —                                   |
